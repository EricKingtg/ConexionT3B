...
public class QryRespDTO {
	...
	public String toString() {
		return "QryRespDTO [res=" + res + ", msg=" + msg + ", numReg=" + numReg + ", columnas=" + columnas
				+ ", datosTabla=" + datosTabla + ", datosLista=" + datosLista + ", resultado=" + resultado
				+ ", metadatos=" + metadatos + ", metadatosParam=" + metadatosParam + ", paramOut=" + paramOut + "]";
	}
